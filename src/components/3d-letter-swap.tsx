...
> {
  ...
  /** Gate scroll-triggered playback until the host says it is ready */
  readyToPlay?: boolean;
  ...
  return (
    ...
    >
      ...
      <span
        ...
        style={{
          // En línea y no por clase: si la hoja de estilos todavía no aplicó,
          // esta cara se dibujaría en flujo y cada letra se vería duplicada.
          position: "absolute",
          top: 0,
          left: 0,
...
const ThreeDLetterSwap: React.FC<ThreeDLetterSwapProps> = ({
  ...
  useEffect(() => {
    if (!playOnScroll || hasPlayedOnScroll || !shouldAnimate || !readyToPlay)
      return;
  ...
  const content = (
    <>
      ...
      {/* Los glifos existen dos veces (cara frontal y trasera), así que se
          ocultan en bloque; `preserve-3d` deja pasar la perspectiva del
          contenedor hasta las letras. */}
      <span
        aria-hidden="true"
          ...
          (
            ...
            return (
              ...
              >
                ...
                {wordObj.needsSpace && (
                  // Venía en `1ch`, el ancho del glifo "0". En una tipografía de
                  // titular eso es casi el doble de un espacio real y abría
                  // huecos entre las palabras. 0.28em es el espacio de Outfit.
                  <span
                    style={{
                      display: "inline-block",
                      width: "0.28em",
